...
The col names and type were fixed, and the same with Reports data set, the registrations were filtered to includ only the ones from the 2nd of October 2020 and onward
...
There is higher rate of male participation with 122 to 89,whre earlier findings had higher female or mostly equal participation rates.
...
The vast majority have no acquaintances also participating, and are not part of other citizen sciense projects
